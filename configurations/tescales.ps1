...
Configuration tescales {
    Node localhost
    {
        win10.devops {
            remoteUserName  = (Get-AutomationVariable "mgmtUserName") 
            tenantId        = (Get-AutomationVariable "tenantId")
            azResourceGroup = (Get-AutomationVariable "mgmtResourceGroup")
            azLocation      = (Get-AutomationVariable "mgmtLocation")
            azConfigUrl     = (Get-AutomationVariable "mgmtConfigUrl")
        }
